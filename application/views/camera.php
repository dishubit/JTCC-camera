        ...
        <div class="my-auto">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <div class="panel panel-default">
                ...
                <?php echo form_open_multipart('crud/add'); ?>
                    <?php if (validation_errors()) {
                        ?>
                        ...
                        <div class="table-responsive">
							...
							<div style="margin-top: 0px" class="form-group">
                                ...
                                <input class="form-control" id="link" name="link" type="text" placeholder="Link RTSP" value="<?php echo set_value('link'); ?>">
                        		<span class="help-block">Masukkan Link RTSP seperti : rtsp://......</span>
							</div>
