<div class="clearfix"></div>
      ...
      <div class="col-sm-12">
        <div class="my-auto"><h1>Edit Data Camera</h1> 
          <br>
         ...
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <div class="panel panel-default">
                ...
                <?php echo form_open_multipart('crud/edit/'.$this->uri->segment(3)); ?>
                    <?php if (validation_errors()) {
                        ...
                        <div class="table-responsive">
                              ...
                              <div style="margin-top: 0px" class="form-group">
                                <label>link</label>
                                <input class="form-control" id="link" name="link" type="text" placeholder="link" value="<?php echo $key->link; ?> ">
                            </div>
                            ...
                            <div style="margin-top: " class="form-group">
                                            ...
                                            <!-- <select name="id_terminal">
                                            	<?php 
                                                    $nama_terminal= set_value('nama_terminal',$terminal['nama_terminal']);
                                                    foreach($terminal as $key){
                                                        $selected=$key['nama_terminal']==$nama_terminal ? "selected": "" ?>
                                                        <option value="<?=$key['id']?>" <?= $selected ?>><?=$key['nama_terminal']?></option>
                                                    <?php } ?>
                                                    }
                                            	 ?>
                                            </select> -->
                                            ...
                                            <?php foreach ($terminal as $key) { ?>
                                                 <?php echo "<option value='".$key->id_terminal."' selected>".$key->nama_terminal."</option>" ?>
                                            <?php } ?>
                                            </select>
                                        </div>
