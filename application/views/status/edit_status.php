<div class="clearfix"></div>
      ...
      <div class="col-sm-12">
        <div class="my-auto"><h1>Edit Data Status</h1> 
          <br>
         ...
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               <div class="panel panel-default">
                        <?php foreach ($get_status as $key) {
                        ?>
                        <div class="panel-body">
                <?php echo form_open_multipart('status/edit/'.$this->uri->segment(3)); ?>
                    <?php if (validation_errors()) {
                        ...
                        <div class="table-responsive">
                            ...
                            <div style="margin-top: " class="form-group">
                                            ...
                                            <?php foreach ($get_status as $stat) { 
                                            	if ($stat->id_status == $this->uri->segment(3)) {
                                            	 	foreach ($terminal as $ter) { 
                                            ?>
                                            		<?php echo "<option value='$ter->id_terminal' ".($cam->id_terminal == $ter->id_terminal ? " selected='selected'" : "" ).">".$ter->nama_terminal."</option>" ?>
                                            		<?php	}
                                            	} ?>
                              ...
                              <div style="margin-top: 0px" class="form-group">
                                <label>Ip</label>
                                <input class="form-control" id="ip" name="ip" type="text" placeholder="ip" value="<?php echo $key->ip; ?> ">
                            </div>
